"""
Django settings for concept_photography project.
...
SECRET_KEY = 'n6rn*b14j=97-sk42b(k3_*vdsligjqm&m_3amv%xv=rb2ij)('
...
ROOT_URLCONF = 'concept_photography.urls'
...
WSGI_APPLICATION = 'concept_photography.wsgi.application'
